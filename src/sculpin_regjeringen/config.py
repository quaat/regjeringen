...
class Settings(BaseModel):
    ...
    base_url: HttpUrl = "https://www.regjeringen.no/"
    robots_url: HttpUrl = "https://www.regjeringen.no/robots.txt"
    sitemap_url: HttpUrl = "https://www.regjeringen.no/globalassets/sitemap/sitemap.xml"
